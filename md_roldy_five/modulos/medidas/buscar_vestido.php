<?php
	...
	$salida = "";
	$query= "SELECT cliente.id as cliente_id, CONCAT (cliente.nombre,' ', cliente.apellidos) as nombre,medidas.id as medida_id, medidas.cintura, medidas.cadera,vestido.id as vestido_id, vestido.largo, vestido.talle, vestido.espalda, vestido.busto,largo_manga.corto as corto_l, largo_manga.3_4 as 3_4_l, largo_manga.largo as largo_l, ancho_manga.corto as corto_a, ancho_manga.3_4 as 3_4_a, ancho_manga.largo as largo_a FROM medidas 
	...
	if (isset($_POST['consulta'])) {
		...
		if ($resultado->num_rows > 0) {
			$salida.="<h5 class=''><p>Medidas para vestido</p></h5><table class='striped responsive-table' border='1'>
		<thead>  
    <tr>
    	<th>Opciones</th>
		...
		$salida.="
				<tr id='cuerpo'>
					<td>
						<a href='#modal2' id='llenar' class='amber darken-2 btn' onclick='mostrar(".$row['cliente_id'].");'> <i class='material-icons amber darken-2 tiny'>create</i></a></div>
					</td>
